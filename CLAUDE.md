...
- Models: 22
- Routes: 149 across 26 controllers
- Async: 14 jobs
...
- _...7 more (use `rails_get_model_details` tool)_
...
- Follow hotwire + service_objects + presenters + view_components + phlex + stimulus + importmaps + concerns_models + concerns_controllers + policies + serializers + pwa + docker + kamal + ci_github_actions + solid_queue + solid_cache + solid_cable + dry_rb + zeitwerk architecture
