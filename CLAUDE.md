...
- Models: 20
- Routes: 148 across 25 controllers
- Async: 13 jobs
- Migrations: 105 total, 0 pending
- Auth: Devise
...
- **SlackChannel** (1a, 3v) — has_many :notification_deliveries
- **SlackDelivery** (2a, 5v) — belongs_to :article, belongs_to :notification_channel
- _...5 more (use `rails_get_model_details` tool)_
