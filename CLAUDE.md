...
> Generated by rails-ai-context v5.16.1
## Stack
- Database: PostgreSQL - 30 tables
- Models: 21
- Routes: 156 app routes across 33 controllers (185 total incl. framework)
...
- **Article** (13a, 7v) - has_many :boosts, has_many :taggings, has_many :base_tags, has_many :tag_taggings, has_many :tags, has_one :pg_search_document, belongs_to :user, belongs_to :site, belongs_to :federails_actor, has_many :posts, has_many :notification_deliveries, has_one :thumbnail_attachment, has_one :thumbnail_blob
  scopes: full_text_search_for, related, unrelated, confirmed, without_toast, for_admin_index | INDEX_NOW_WATCHED_ATTRIBUTES: slug, title, title_ko, title_ja, body, summary_body, summary_body_ja, published_at
...
- normalizations
- view_components
**Services:** ArticleAgentsService, ContentService, DeeplTranslationService, DiscordDeliveryService, IndexNowService, MastodonService, OperationService, PushNotificationService, SlackDeliveryService, SocialMediaService, TwitterService
**Jobs:** ArticleBatchJob, ArticleJob, ArticleReembedJob, ArticleThumbnailJob, DiscardedArticleCleanupJob, DiscordArticleDeliveryJob, GmailArticleJob, HackerNewsSiteJob, IndexNowJob, JapaneseTempJob, RedditSiteJob, ReplyNotificationJob, RssSiteJob, RssSitePageJob, SlackArticleDeliveryJob, SocialDeleteJob, SocialPostJob, YoutubeSiteJob
## Commands
