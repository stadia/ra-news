...
- Models: 20
- Routes: 150 across 24 controllers
- Async: 13 jobs
...
- Follow hotwire + service_objects + presenters + view_components + phlex + stimulus + importmaps + concerns_models + concerns_controllers + pwa + docker + kamal + ci_github_actions + solid_queue + solid_cache + solid_cable + dry_rb + zeitwerk architecture
