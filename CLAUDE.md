...
> Generated by rails-ai-context v4.3.2
...
- Follow hotwire + service_objects + view_components + phlex + stimulus + importmaps + concerns_models + concerns_controllers + pwa + docker + kamal + ci_github_actions + solid_queue + solid_cache + solid_cable + dry_rb architecture
