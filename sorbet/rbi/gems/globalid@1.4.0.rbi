...
# pkg:gem/globalid#lib/global_id/fixture_set.rb:4
module GlobalID::FixtureSet
  # pkg:gem/globalid#lib/global_id/fixture_set.rb:5
  def global_id(fixture_set_name, label, column_type: T.unsafe(nil), **options); end

  # pkg:gem/globalid#lib/global_id/fixture_set.rb:9
  def signed_global_id(fixture_set_name, label, column_type: T.unsafe(nil), **options); end

  private

  # pkg:gem/globalid#lib/global_id/fixture_set.rb:14
