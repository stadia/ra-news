...
#
# pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:6
module AESKeyWrap
  class << self
    ...
    # @see #unwrap!
    #
    # pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:77
    ...
    # @see #unwrap
    #
    # pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:116
    def unwrap!(*args); end
    ...
    #
    # pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:28
    def wrap(unwrapped_key, kek, iv = T.unsafe(nil)); end

    private

    # pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:124
    def aes(encrypt_or_decrypt, key, data); end

    # pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:133
    def coerce_uint64(value); end
  end
end

# pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:7
AESKeyWrap::DEFAULT_IV = T.let(T.unsafe(nil), Integer)

# pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:8
AESKeyWrap::IV_SIZE = T.let(T.unsafe(nil), Integer)

# bytes
#
# pkg:gem/aes_key_wrap#lib/aes_key_wrap.rb:10
