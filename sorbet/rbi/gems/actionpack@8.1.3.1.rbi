...
class ActionController::API < ::ActionController::Metal
  ...
  # pkg:gem/actionpack#lib/action_controller/api.rb:153
  def _helper_methods; end
  ...
  # pkg:gem/actionpack#lib/action_controller/api.rb:154
  ...
  # pkg:gem/actionpack#lib/action_controller/api.rb:154
  def render_serialized_json(obj, params: T.unsafe(nil), with: T.unsafe(nil), root_key: T.unsafe(nil), meta: T.unsafe(nil), &block); end
  ...
  # pkg:gem/actionpack#lib/action_controller/api.rb:154
  def serialize(obj, params: T.unsafe(nil), with: T.unsafe(nil), root_key: T.unsafe(nil), meta: T.unsafe(nil), &block); end
...
class ActionController::Base < ::ActionController::Metal
  ...
  # pkg:gem/actionpack#lib/action_controller/base.rb:331
  def mimes_for_respond_to; end
...
#
# pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:114
class ActionDispatch::SystemTestCase < ::ActiveSupport::TestCase
  ...
  # pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:205
  ...
  # pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:173
  def url_helpers; end
  ...
  class << self
    ...
    #
    # pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:158
    def driven_by(driver, using: T.unsafe(nil), screen_size: T.unsafe(nil), options: T.unsafe(nil), &capabilities); end

    # pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:138
    def driver; end
    ...
    #
    # pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:167
    def served_by(host:, port:); end

    # pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:128
...
# pkg:gem/actionpack#lib/action_dispatch/system_test_case.rb:120
ActionDispatch::SystemTestCase::DEFAULT_HOST = T.let(T.unsafe(nil), String)

# pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:6
module ActionDispatch::SystemTesting; end

# pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:7
class ActionDispatch::SystemTesting::Browser
  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:10
  def initialize(name); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:35
  def configure; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:8
  def name; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:25
  def options; end

  # driver_path is lazily initialized by default. Eagerly set it to avoid race
  # conditions when using parallel tests.
  #
  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:41
  def preload; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:14
  def type; end

  private

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:51
  def default_chrome_options; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:59
  def default_firefox_options; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/browser.rb:65
  def resolve_driver_path(namespace); end
end

# pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:7
class ActionDispatch::SystemTesting::Driver
  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:10
  def initialize(driver_type, **options, &capabilities); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:8
  def name; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:27
  def use; end

  private

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:51
  def browser_options; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:38
  def register; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:61
  def register_cuprite(app); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:69
  def register_playwright(app); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:65
  def register_rack_test(app); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:55
  def register_selenium(app); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:34
  def registerable?; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/driver.rb:80
  def setup; end
end

# pkg:gem/actionpack#lib/action_dispatch/system_testing/server.rb:7
class ActionDispatch::SystemTesting::Server
  # pkg:gem/actionpack#lib/action_dispatch/system_testing/server.rb:14
  def run; end

  private

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/server.rb:28
  def set_port; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/server.rb:24
  def set_server; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/server.rb:19
  def setup; end

  class << self
    # pkg:gem/actionpack#lib/action_dispatch/system_testing/server.rb:9
...
# pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:7
module ActionDispatch::SystemTesting::TestHelpers; end

# Screenshot helper for system testing.
#
# pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:9
module ActionDispatch::SystemTesting::TestHelpers::ScreenshotHelper
  # Takes a screenshot of the current page in the browser if the test failed.
  #
  # `take_failed_screenshot` is called during system test teardown.
  #
  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:53
  ...
  #
  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:41
  def take_screenshot(html: T.unsafe(nil), screenshot: T.unsafe(nil)); end

  private

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:61
  def _screenshot_counter; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:61
  def _screenshot_counter=(_arg0); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:106
  def absolute_html_path; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:98
  def absolute_image_path; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:90
  def absolute_path; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:134
  def display_image(html:, screenshot_output:); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:154
  def failed?; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:63
  def html_from_env?; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:86
  def html_path; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:76
  def image_name; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:82
  def image_path; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:67
  def increment_unique; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:150
  def inline_base64(path); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:120
  def output_type; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:102
  def relative_image_path; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:111
  def save_html; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:115
  def save_image; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:94
  def screenshots_dir; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:130
  def show(img); end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:158
  def supports_screenshot?; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/screenshot_helper.rb:72
  def unique; end
end

# pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/setup_and_teardown.rb:8
module ActionDispatch::SystemTesting::TestHelpers::SetupAndTeardown
  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/setup_and_teardown.rb:15
  def after_teardown; end

  # pkg:gem/actionpack#lib/action_dispatch/system_testing/test_helpers/setup_and_teardown.rb:9
