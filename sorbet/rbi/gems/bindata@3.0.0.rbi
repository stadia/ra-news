...
class BinData::Base
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:87
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:208
  def =~(other); end

  # Returns the offset (in bytes) of this object with respect to its most
  # distant ancestor.
  #
  # pkg:gem/bindata#lib/bindata/base.rb:219
  def abs_offset; end

  # pkg:gem/bindata#lib/bindata/base.rb:239
  def base_respond_to?(*_arg0); end

  # Resets the internal state to that of a newly created object.
  #
  # pkg:gem/bindata#lib/bindata/base.rb:146
  def clear; end

  # Returns a user friendly name of this object for debugging purposes.
  #
  # pkg:gem/bindata#lib/bindata/base.rb:213
  def debug_name; end
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:119
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:136
  def get_parameter(key); end

  # Returns whether +key+ exists in the +parameters+ hash.
  #
  # pkg:gem/bindata#lib/bindata/base.rb:141
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:193
  def inspect; end
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:235
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:188
  def to_hex(&block); end

  # Return a string representing this data object.
  #
  # pkg:gem/bindata#lib/bindata/base.rb:198
  def to_s; end

  # Writes the value for this data object to +io+.
  #
  # pkg:gem/bindata#lib/bindata/base.rb:164
  ...
  # pkg:gem/bindata#lib/bindata/base.rb:281
  def binary_string(str); end

  # pkg:gem/bindata#lib/bindata/base.rb:244
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:256
  def reading?; end

  # pkg:gem/bindata#lib/bindata/base.rb:248
  def start_read; end

  # pkg:gem/bindata#lib/bindata/base.rb:270
  def top_level; end

  # pkg:gem/bindata#lib/bindata/base.rb:264
  def top_level_get(sym); end

  # pkg:gem/bindata#lib/bindata/base.rb:260
  ...
  class << self
    ...
    # pkg:gem/bindata#lib/bindata/base.rb:57
    ...
    #
    # pkg:gem/bindata#lib/bindata/base.rb:55
...
#
# pkg:gem/bindata#lib/bindata/base.rb:291
class BinData::BaseArgProcessor
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:296
  ...
  # by the data object.
  #
  # pkg:gem/bindata#lib/bindata/base.rb:329
  ...
  #
  # pkg:gem/bindata#lib/bindata/base.rb:305
...
module BinData::BitField
  class << self
    # pkg:gem/bindata#lib/bindata/bits.rb:86
    def create_clamp_code(nbits, signed); end

    # pkg:gem/bindata#lib/bindata/bits.rb:78
    def create_do_num_bytes_code(nbits); end

    # pkg:gem/bindata#lib/bindata/bits.rb:94
    def create_dynamic_clamp_code(signed); end

    # pkg:gem/bindata#lib/bindata/bits.rb:106
    def create_fixed_clamp_code(nbits, signed); end

    # pkg:gem/bindata#lib/bindata/bits.rb:129
    def create_int2uint_code(nbits, signed); end

    # pkg:gem/bindata#lib/bindata/bits.rb:70
    def create_nbits_code(nbits); end

    # pkg:gem/bindata#lib/bindata/bits.rb:62
    def create_params_code(nbits); end

    # pkg:gem/bindata#lib/bindata/bits.rb:139
...
#
# pkg:gem/bindata#lib/bindata/bits.rb:160
module BinData::BitFieldFactory
  # pkg:gem/bindata#lib/bindata/bits.rb:161
...
#
# pkg:gem/bindata#lib/bindata/dsl.rb:279
class BinData::DSLMixin::DSLBigAndLittleEndianHandler
  class << self
    ...
    # pkg:gem/bindata#lib/bindata/dsl.rb:293
    def create_subclasses_with_endian(bnl_class); end

    # pkg:gem/bindata#lib/bindata/dsl.rb:314
    def delegate_field_creation(bnl_class); end

    # pkg:gem/bindata#lib/bindata/dsl.rb:327
    def fixup_subclass_hierarchy(bnl_class); end

    # pkg:gem/bindata#lib/bindata/dsl.rb:281
    def handle(bnl_class); end

    # pkg:gem/bindata#lib/bindata/dsl.rb:289
    def make_class_abstract(bnl_class); end

    # pkg:gem/bindata#lib/bindata/dsl.rb:356
    def obj_attribute(obj, attr); end

    # pkg:gem/bindata#lib/bindata/dsl.rb:298
...
#
# pkg:gem/bindata#lib/bindata/dsl.rb:363
class BinData::DSLMixin::DSLFieldParser
  # pkg:gem/bindata#lib/bindata/dsl.rb:364
  def initialize(namespace, hints, symbol, *args, &block); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:372
  def name; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:374
  def name_from_field_declaration(args); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:372
  def params; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:393
  def params_from_args(args); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:400
  def params_from_block(&block); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:383
...
#
# pkg:gem/bindata#lib/bindata/dsl.rb:427
class BinData::DSLMixin::DSLFieldValidator
  # pkg:gem/bindata#lib/bindata/dsl.rb:428
  def initialize(the_class, parser); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:477
  def all_or_none_names_failed?(name); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:492
  def duplicate_name?(name); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:449
  def ensure_valid_name(name); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:504
  def fields; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:488
  ...
  # pkg:gem/bindata#lib/bindata/dsl.rb:500
  def name_is_reserved?(name); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:496
  def name_shadows_method?(name); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:508
  def option?(opt); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:433
...
class BinData::DSLMixin::DSLParser
  ...
  # pkg:gem/bindata#lib/bindata/dsl.rb:132
  def dsl_params; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:78
  def endian(endian = T.unsafe(nil)); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:128
  def fields; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:117
  def hide(*args); end
  ...
  # pkg:gem/bindata#lib/bindata/dsl.rb:75
  def parser_type; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:87
  def search_namespace(*args); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:102
  def search_prefix(*args); end

  private

  # pkg:gem/bindata#lib/bindata/dsl.rb:211
  def append_field(type, name, params); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:227
  def dsl_raise(exception, msg); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:162
  def ensure_hints; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:197
  def fields?; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:168
  def hints; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:158
  def option?(opt); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:217
  def parent_attribute(attr, default = T.unsafe(nil)); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:193
  def parent_fields; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:201
  def parse_and_append_field(*args, &block); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:145
  def parser_abilities; end

  # pkg:gem/bindata#lib/bindata/dsl.rb:172
  def set_endian(endian); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:245
  def to_choice_params(key); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:234
  def to_object_params(key); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:257
  def to_struct_params(*_); end

  # pkg:gem/bindata#lib/bindata/dsl.rb:189
...
# pkg:gem/bindata#lib/bindata/int.rb:15
...
#                       </pre></code>
#
# pkg:gem/bindata#lib/bindata/name.rb:22
module BinData::RegisterNamePlugin
  # pkg:gem/bindata#lib/bindata/name.rb:29
  def initialize_shared_instance; end

  class << self
    # pkg:gem/bindata#lib/bindata/name.rb:24
...
#
# pkg:gem/bindata#lib/bindata/registry.rb:176
...
#
# pkg:gem/bindata#lib/bindata/registry.rb:22
class BinData::Registry
  # pkg:gem/bindata#lib/bindata/registry.rb:23
  def initialize; end

  # pkg:gem/bindata#lib/bindata/registry.rb:45
  def lookup(namespace, name, hints = T.unsafe(nil)); end

  # pkg:gem/bindata#lib/bindata/registry.rb:28
  def register(namespace, name, class_to_register); end

  # Convert CamelCase +name+ to underscore style.
  #
  # pkg:gem/bindata#lib/bindata/registry.rb:65
  ...
  #
  # pkg:gem/bindata#lib/bindata/registry.rb:110
  def backwards_compatible_search_names(name, hints); end

  # pkg:gem/bindata#lib/bindata/registry.rb:141
  def name_with_endian(name, endian); end

  # pkg:gem/bindata#lib/bindata/registry.rb:131
  def name_with_prefix(name, prefix); end

  # pkg:gem/bindata#lib/bindata/registry.rb:152
  def register_dynamic_class(name); end

  # pkg:gem/bindata#lib/bindata/registry.rb:78
  def search_names(namespace, name, hints); end

  # pkg:gem/bindata#lib/bindata/registry.rb:166
...
class BinData::SanitizedBigEndian < ::BinData::SanitizedParameter
  # pkg:gem/bindata#lib/bindata/sanitize.rb:151
  def endian; end
end
...
class BinData::SanitizedChoices < ::BinData::SanitizedParameter
  # pkg:gem/bindata#lib/bindata/sanitize.rb:126
  def initialize(choices, namespace, hints); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:144
  def [](key); end
end
...
class BinData::SanitizedFields < ::BinData::SanitizedParameter
  ...
  # pkg:gem/bindata#lib/bindata/sanitize.rb:87
  def [](idx); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:77
  def add_field(type, name, params); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:111
  def all_field_names_blank?; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:119
  def any_field_has_parameter?(parameter); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:99
  def each(&block); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:91
  def empty?; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:107
  def field_name?(name); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:103
  def field_names; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:95
  def length; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:115
  def no_field_names_blank?; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:83
  def raw_fields; end
end

# pkg:gem/bindata#lib/bindata/sanitize.rb:156
class BinData::SanitizedLittleEndian < ::BinData::SanitizedParameter
  # pkg:gem/bindata#lib/bindata/sanitize.rb:157
  def endian; end
end
...
# at a single time.
#
# pkg:gem/bindata#lib/bindata/sanitize.rb:174
class BinData::SanitizedParameters < ::Hash
  # pkg:gem/bindata#lib/bindata/sanitize.rb:194
  ...
  # pkg:gem/bindata#lib/bindata/sanitize.rb:217
  def has_at_least_one_of?(*keys); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:215
  def has_parameter?(_arg0); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:305
  def hints; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:267
  ...
  #    end
  #
  # pkg:gem/bindata#lib/bindata/sanitize.rb:247
  def must_be_integer(*keys); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:225
  def must_have_at_least_one_of(*keys); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:261
  def rename_parameter(old_key, new_key); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:295
  def sanitize(key, &block); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:285
  def sanitize_choices(key, &block); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:291
  def sanitize_endian(key); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:277
  def sanitize_fields(key, &block); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:271
  def sanitize_object_prototype(key); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:231
  def warn_replacement_parameter(bad_key, suggested_key); end

  private

  # pkg:gem/bindata#lib/bindata/sanitize.rb:377
  def create_sanitized_choices(choices); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:365
  def create_sanitized_endian(endian); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:381
  def create_sanitized_fields; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:385
  def create_sanitized_object_prototype(obj_type, obj_params); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:345
  def ensure_mandatory_parameters_exist; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:354
  def ensure_mutual_exclusion_of_parameters; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:330
  def ensure_no_nil_values; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:339
  def merge_default_parameters!; end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:326
  def needs_sanitizing?(key); end

  # pkg:gem/bindata#lib/bindata/sanitize.rb:316
  def sanitize!; end

  class << self
    # pkg:gem/bindata#lib/bindata/sanitize.rb:180
...
# pkg:gem/bindata#lib/bindata/sanitize.rb:177
...
class BinData::Struct < ::BinData::Base
  # pkg:gem/bindata#lib/bindata/struct.rb:155
  def [](key); end

  # pkg:gem/bindata#lib/bindata/struct.rb:159
  def []=(key, value); end

  # pkg:gem/bindata#lib/bindata/struct.rb:103
  def assign(val); end

  # pkg:gem/bindata#lib/bindata/struct.rb:95
  def clear; end

  # pkg:gem/bindata#lib/bindata/struct.rb:99
  def clear?; end

  # pkg:gem/bindata#lib/bindata/struct.rb:129
  def debug_name_of(child); end

  # pkg:gem/bindata#lib/bindata/struct.rb:150
  def do_num_bytes; end

  # pkg:gem/bindata#lib/bindata/struct.rb:140
  def do_read(io); end

  # pkg:gem/bindata#lib/bindata/struct.rb:145
  def do_write(io); end
  ...
  # +include_all+ is true.
  #
  # pkg:gem/bindata#lib/bindata/struct.rb:171
  ...
  # in the listing.
  #
  # pkg:gem/bindata#lib/bindata/struct.rb:120
  ...
  # pkg:gem/bindata#lib/bindata/struct.rb:91
  def initialize_instance; end

  # pkg:gem/bindata#lib/bindata/struct.rb:83
  def initialize_shared_instance; end

  # pkg:gem/bindata#lib/bindata/struct.rb:163
  def key?(key); end

  # pkg:gem/bindata#lib/bindata/struct.rb:134
  def offset_of(child); end

  # pkg:gem/bindata#lib/bindata/struct.rb:108
  def snapshot; end

  private

  # pkg:gem/bindata#lib/bindata/struct.rb:248
  def as_stringified_hash(val); end

  # pkg:gem/bindata#lib/bindata/struct.rb:237
  def assign_fields(val); end

  # pkg:gem/bindata#lib/bindata/struct.rb:222
  def base_field_name(name); end

  # pkg:gem/bindata#lib/bindata/struct.rb:188
  def define_field_accessors; end

  # pkg:gem/bindata#lib/bindata/struct.rb:195
  def define_field_accessors_for(name, index); end

  # pkg:gem/bindata#lib/bindata/struct.rb:210
  def find_index_of(obj); end

  # pkg:gem/bindata#lib/bindata/struct.rb:214
  def find_obj_for_name(name); end

  # pkg:gem/bindata#lib/bindata/struct.rb:282
  def include_obj?(obj); end

  # pkg:gem/bindata#lib/bindata/struct.rb:276
  def include_obj_for_io?(obj); end

  # pkg:gem/bindata#lib/bindata/struct.rb:226
  def instantiate_all_objs; end

  # pkg:gem/bindata#lib/bindata/struct.rb:230
  def instantiate_obj_at(index); end

  # pkg:gem/bindata#lib/bindata/struct.rb:264
  def sum_num_bytes_below_index(index); end

  # pkg:gem/bindata#lib/bindata/struct.rb:260
...
module BinData::Struct::ByteAlignPlugin
  # pkg:gem/bindata#lib/bindata/struct.rb:362
  def align_obj?(obj); end

  # pkg:gem/bindata#lib/bindata/struct.rb:357
  def bytes_to_align(obj, rel_offset); end

  # pkg:gem/bindata#lib/bindata/struct.rb:303
  def do_read(io); end

  # pkg:gem/bindata#lib/bindata/struct.rb:321
  def do_write(io); end

  # pkg:gem/bindata#lib/bindata/struct.rb:339
  def sum_num_bytes_below_index(index); end
end

# These reserved words may not be used as field names
#
# pkg:gem/bindata#lib/bindata/struct.rb:66
...
class BinData::Struct::Snapshot < ::Hash
  # pkg:gem/bindata#lib/bindata/struct.rb:288
  def []=(key, value); end
  ...
  # pkg:gem/bindata#lib/bindata/struct.rb:292
  def respond_to_missing?(symbol, include_all = T.unsafe(nil)); end
end

# pkg:gem/bindata#lib/bindata/struct.rb:368
class BinData::StructArgProcessor < ::BinData::BaseArgProcessor
  # pkg:gem/bindata#lib/bindata/struct.rb:369
  def sanitize_parameters!(obj_class, params); end

  private

  # pkg:gem/bindata#lib/bindata/struct.rb:428
  def ensure_field_names_are_valid(obj_class, field_names); end

  # pkg:gem/bindata#lib/bindata/struct.rb:424
  def hidden_field_names(hidden); end

  # pkg:gem/bindata#lib/bindata/struct.rb:380
  def sanitize_endian(params); end

  # pkg:gem/bindata#lib/bindata/struct.rb:400
  def sanitize_fields(obj_class, params); end

  # pkg:gem/bindata#lib/bindata/struct.rb:411
  def sanitize_hide(params); end

  # pkg:gem/bindata#lib/bindata/struct.rb:384
  def sanitize_search_namespace(params); end

  # pkg:gem/bindata#lib/bindata/struct.rb:390
