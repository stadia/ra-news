...
#
# pkg:gem/fileutils#lib/fileutils.rb:182
module FileUtils
  ...
  # pkg:gem/fileutils#lib/fileutils.rb:1658
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:239
  def cd(dir, verbose: T.unsafe(nil), &block); end

  # pkg:gem/fileutils#lib/fileutils.rb:247
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1894
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1505
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1528
  def compare_stream(a, b); end

  # pkg:gem/fileutils#lib/fileutils.rb:879
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1037
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1073
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1085
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:870
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:628
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:982
  ...
  # pkg:gem/fileutils#lib/fileutils.rb:2534
  def fu_clean_components(*comp); end

  # pkg:gem/fileutils#lib/fileutils.rb:2525
  def fu_common_components(target, base); end

  # pkg:gem/fileutils#lib/fileutils.rb:2465
  def fu_each_src_dest(src, dest); end

  # pkg:gem/fileutils#lib/fileutils.rb:2473
  def fu_each_src_dest0(src, dest, target_directory = T.unsafe(nil)); end

  # pkg:gem/fileutils#lib/fileutils.rb:1945
  def fu_get_gid(group); end

  # pkg:gem/fileutils#lib/fileutils.rb:1931
  def fu_get_uid(user); end

  # pkg:gem/fileutils#lib/fileutils.rb:1420
  def fu_have_symlink?; end

  # class Entry_
  #
  # pkg:gem/fileutils#lib/fileutils.rb:2460
  def fu_list(arg); end

  # pkg:gem/fileutils#lib/fileutils.rb:397
  def fu_mkdir(path, mode); end

  # pkg:gem/fileutils#lib/fileutils.rb:1719
  def fu_mode(mode, path); end

  # pkg:gem/fileutils#lib/fileutils.rb:2499
  def fu_output_message(msg); end

  # pkg:gem/fileutils#lib/fileutils.rb:2494
  def fu_same?(a, b); end

  # pkg:gem/fileutils#lib/fileutils.rb:2509
  def fu_split_path(path); end

  # pkg:gem/fileutils#lib/fileutils.rb:2557
  def fu_starting_path?(path); end

  # pkg:gem/fileutils#lib/fileutils.rb:1429
  def fu_stat_identical_entry?(a, b); end

  # pkg:gem/fileutils#lib/fileutils.rb:203
  def getwd; end

  # pkg:gem/fileutils#lib/fileutils.rb:1515
  ...
  # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1607
  ...
  # pkg:gem/fileutils#lib/fileutils.rb:527
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:809
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:517
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:707
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:317
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1154
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:198
  def pwd; end

  # pkg:gem/fileutils#lib/fileutils.rb:1224
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1489
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1446
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1348
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1470
  def remove_file(path, force = T.unsafe(nil)); end

  # pkg:gem/fileutils#lib/fileutils.rb:277
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1213
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1238
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1296
  ...
  # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
  #
  # pkg:gem/fileutils#lib/fileutils.rb:1325
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:2004
  ...
  #
  # pkg:gem/fileutils#lib/fileutils.rb:265
  def uptodate?(new, old_list); end

  # pkg:gem/fileutils#lib/fileutils.rb:1640
  ...
  class << self
    ...
    # Related: FileUtils.pwd.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:245
    def cd(dir, verbose: T.unsafe(nil), &block); end

    # pkg:gem/fileutils#lib/fileutils.rb:248
    def chdir(dir, verbose: T.unsafe(nil), &block); end
    ...
    # Related: FileUtils.chmod_R.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1809
    def chmod(mode, list, noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # Like FileUtils.chmod, but changes permissions recursively.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1829
    def chmod_R(mode, list, noop: T.unsafe(nil), verbose: T.unsafe(nil), force: T.unsafe(nil)); end
    ...
    # Related: FileUtils.chown_R.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1906
    def chown(user, group, list, noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # Like FileUtils.chown, but changes owner and group recursively.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1929
    def chown_R(user, group, list, noop: T.unsafe(nil), verbose: T.unsafe(nil), force: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:1518
    def cmp(a, b); end
    ...
    #
    # pkg:gem/fileutils#lib/fileutils.rb:2616
    ...
    #
    # pkg:gem/fileutils#lib/fileutils.rb:2577
    def commands; end
    ...
    # Related: FileUtils.compare_stream.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1513
    def compare_file(a, b); end
    ...
    # Related: FileUtils.compare_file.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1541
    def compare_stream(a, b); end

    # pkg:gem/fileutils#lib/fileutils.rb:880
    def copy(src, dest, preserve: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1051
    def copy_entry(src, dest, preserve = T.unsafe(nil), dereference_root = T.unsafe(nil), remove_destination = T.unsafe(nil)); end
    ...
    # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1078
    def copy_file(src, dest, preserve = T.unsafe(nil), dereference = T.unsafe(nil)); end
    ...
    # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1088
    def copy_stream(src, dest); end
    ...
    # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:877
    def cp(src, dest, preserve: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:636
    def cp_lr(src, dest, noop: T.unsafe(nil), verbose: T.unsafe(nil), dereference_root: T.unsafe(nil), remove_destination: T.unsafe(nil)); end
    ...
    # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:990
    def cp_r(src, dest, preserve: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil), dereference_root: T.unsafe(nil), remove_destination: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:204
    def getwd; end
    ...
    #
    # pkg:gem/fileutils#lib/fileutils.rb:2595
    def have_option?(mid, opt); end

    # pkg:gem/fileutils#lib/fileutils.rb:1517
    def identical?(a, b); end
    ...
    # Related: {methods for copying}[rdoc-ref:FileUtils@Copying].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1638
    def install(src, dest, mode: T.unsafe(nil), owner: T.unsafe(nil), group: T.unsafe(nil), preserve: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:528
    def link(src, dest, force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: FileUtils.ln (has different options).
    #
    # pkg:gem/fileutils#lib/fileutils.rb:816
    def link_entry(src, dest, dereference_root = T.unsafe(nil), remove_destination = T.unsafe(nil)); end
    ...
    # Related: FileUtils.link_entry (has different options).
    #
    # pkg:gem/fileutils#lib/fileutils.rb:525
    def ln(src, dest, force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: FileUtils.ln_sf.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:719
    def ln_s(src, dest, force: T.unsafe(nil), relative: T.unsafe(nil), target_directory: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # Like FileUtils.ln_s, but always with keyword argument <tt>force: true</tt> given.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:729
    def ln_sf(src, dest, noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # Like FileUtils.ln_s, but create links relative to +dest+.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:766
    def ln_sr(src, dest, target_directory: T.unsafe(nil), force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:395
    def makedirs(list, mode: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: FileUtils.mkdir_p.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:326
    def mkdir(list, mode: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: FileUtils.mkdir.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:390
    def mkdir_p(list, mode: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:394
    def mkpath(list, mode: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:1184
    def move(src, dest, force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil), secure: T.unsafe(nil)); end
    ...
    #     mv src1.txt src1 dest1
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1181
    def mv(src, dest, force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil), secure: T.unsafe(nil)); end
    ...
    #
    # pkg:gem/fileutils#lib/fileutils.rb:2585
    def options; end
    ...
    #
    # pkg:gem/fileutils#lib/fileutils.rb:2606
    def options_of(mid); end

    # pkg:gem/fileutils#lib/fileutils.rb:186
    ...
    # Related: FileUtils.cd.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:201
    def pwd; end

    # pkg:gem/fileutils#lib/fileutils.rb:1225
    def remove(list, force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1493
    def remove_dir(path, force = T.unsafe(nil)); end
    ...
    # Related: FileUtils.remove_entry_secure.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1457
    def remove_entry(path, force = T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1418
    def remove_entry_secure(path, force = T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1475
    def remove_file(path, force = T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1222
    def rm(list, force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1241
    def rm_f(list, noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1308
    def rm_r(list, force: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil), secure: T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:1328
    def rm_rf(list, noop: T.unsafe(nil), verbose: T.unsafe(nil), secure: T.unsafe(nil)); end
    ...
    # Related: {methods for deleting}[rdoc-ref:FileUtils@Deleting].
    #
    # pkg:gem/fileutils#lib/fileutils.rb:460
    def rmdir(list, parents: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:1331
    def rmtree(list, noop: T.unsafe(nil), verbose: T.unsafe(nil), secure: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:1244
    def safe_unlink(list, noop: T.unsafe(nil), verbose: T.unsafe(nil)); end

    # pkg:gem/fileutils#lib/fileutils.rb:722
    def symlink(src, dest, force: T.unsafe(nil), relative: T.unsafe(nil), target_directory: T.unsafe(nil), noop: T.unsafe(nil), verbose: T.unsafe(nil)); end
    ...
    # Related: FileUtils.uptodate?.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:2025
    def touch(list, noop: T.unsafe(nil), verbose: T.unsafe(nil), mtime: T.unsafe(nil), nocreate: T.unsafe(nil)); end
    ...
    # Related: FileUtils.touch.
    #
    # pkg:gem/fileutils#lib/fileutils.rb:275
    def uptodate?(new, old_list); end

    private

    # pkg:gem/fileutils#lib/fileutils.rb:187
    def apply_mask(mode, user_mask, op, mode_mask); end
...
#
# pkg:gem/fileutils#lib/fileutils.rb:2683
module FileUtils::DryRun
  ...
  # pkg:gem/fileutils#lib/fileutils.rb:2688
  ...
  class << self
    # pkg:gem/fileutils#lib/fileutils.rb:2697
    def cd(*_arg0); end
...
# pkg:gem/fileutils#lib/fileutils.rb:2068
class FileUtils::Entry_
  include ::FileUtils::StreamUtils_

  # pkg:gem/fileutils#lib/fileutils.rb:2071
  def initialize(a, b = T.unsafe(nil), deref = T.unsafe(nil)); end

  # pkg:gem/fileutils#lib/fileutils.rb:2137
  def blockdev?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2132
  def chardev?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2205
  def chmod(mode); end

  # pkg:gem/fileutils#lib/fileutils.rb:2214
  def chown(uid, gid); end

  # pkg:gem/fileutils#lib/fileutils.rb:2238
  def copy(dest); end

  # pkg:gem/fileutils#lib/fileutils.rb:2276
  def copy_file(dest); end

  # pkg:gem/fileutils#lib/fileutils.rb:2284
  def copy_metadata(path); end

  # pkg:gem/fileutils#lib/fileutils.rb:2104
  def dereference?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2122
  def directory?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2154
  def door?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2159
  def entries; end

  # pkg:gem/fileutils#lib/fileutils.rb:2108
  def exist?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2117
  def file?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2084
  def inspect; end

  # pkg:gem/fileutils#lib/fileutils.rb:2222
  def link(dest); end

  # pkg:gem/fileutils#lib/fileutils.rb:2191
  def lstat; end

  # pkg:gem/fileutils#lib/fileutils.rb:2199
  def lstat!; end

  # pkg:gem/fileutils#lib/fileutils.rb:2088
  def path; end

  # pkg:gem/fileutils#lib/fileutils.rb:2147
  def pipe?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2333
  def platform_support; end

  # pkg:gem/fileutils#lib/fileutils.rb:2363
  def postorder_traverse; end

  # pkg:gem/fileutils#lib/fileutils.rb:2096
  def prefix; end

  # pkg:gem/fileutils#lib/fileutils.rb:2353
  def preorder_traverse; end

  # pkg:gem/fileutils#lib/fileutils.rb:2100
  def rel; end

  # pkg:gem/fileutils#lib/fileutils.rb:2313
  def remove; end

  # pkg:gem/fileutils#lib/fileutils.rb:2321
  def remove_dir1; end

  # pkg:gem/fileutils#lib/fileutils.rb:2327
  def remove_file; end

  # pkg:gem/fileutils#lib/fileutils.rb:2142
  def socket?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2169
  def stat; end

  # pkg:gem/fileutils#lib/fileutils.rb:2179
  def stat!; end

  # pkg:gem/fileutils#lib/fileutils.rb:2127
  def symlink?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2361
  def traverse; end

  # pkg:gem/fileutils#lib/fileutils.rb:2383
  def wrap_traverse(pre, post); end

  private

  # pkg:gem/fileutils#lib/fileutils.rb:2405
  def check_have_lchmod?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2423
  def check_have_lchown?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2451
  def descendant_directory?(descendant, ascendant); end

  # pkg:gem/fileutils#lib/fileutils.rb:2397
  def have_lchmod?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2415
  def have_lchown?; end

  # pkg:gem/fileutils#lib/fileutils.rb:2431
  def join(dir, base); end
end

# pkg:gem/fileutils#lib/fileutils.rb:2623
module FileUtils::LowMethods
  private

  # pkg:gem/fileutils#lib/fileutils.rb:2625
  def _do_nothing(*_arg0); end

  # pkg:gem/fileutils#lib/fileutils.rb:2626
  def cd(*_arg0); end
...
# to methods in FileUtils.
#
# pkg:gem/fileutils#lib/fileutils.rb:2659
module FileUtils::NoWrite
  ...
  # pkg:gem/fileutils#lib/fileutils.rb:2664
  def chmod(*args, **options); end
  ...
  class << self
    # pkg:gem/fileutils#lib/fileutils.rb:2673
    def cd(*_arg0); end
...
# pkg:gem/fileutils#lib/fileutils.rb:2029
module FileUtils::StreamUtils_
  private

  # pkg:gem/fileutils#lib/fileutils.rb:2053
  def fu_blksize(st); end

  # pkg:gem/fileutils#lib/fileutils.rb:2040
  def fu_copy_stream0(src, dest, blksize = T.unsafe(nil)); end

  # pkg:gem/fileutils#lib/fileutils.rb:2060
  def fu_default_blksize; end

  # pkg:gem/fileutils#lib/fileutils.rb:2044
  def fu_stream_blksize(*streams); end

  # pkg:gem/fileutils#lib/fileutils.rb:2037
  def fu_windows?; end
end
...
#
# pkg:gem/fileutils#lib/fileutils.rb:2637
module FileUtils::Verbose
  ...
  # pkg:gem/fileutils#lib/fileutils.rb:2641
  ...
  class << self
    # pkg:gem/fileutils#lib/fileutils.rb:2650
    def cd(*args, **options); end
