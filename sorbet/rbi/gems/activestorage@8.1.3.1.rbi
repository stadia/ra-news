...
class ActiveStorage::Blob < ::ActiveStorage::Record
  include ::ActiveStorage::BlobWithPreviewUrl
...
#
# pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:13
class ActiveStorage::Service::DiskService < ::ActiveStorage::Service
  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:16
  def initialize(root:, public: T.unsafe(nil), **options); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:145
  def compose(source_keys, destination_key, **_arg2); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:53
  def delete(key); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:61
  def delete_prefixed(prefix); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:28
  def download(key, &block); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:42
  def download_chunk(key, range); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:78
  def exist?(key); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:106
  ...
  #
  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:114
  def path_for(key); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:14
  def root; end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:14
  def root=(_arg0); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:21
  def upload(key, io, checksum: T.unsafe(nil), **_arg3); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:86
  def url_for_direct_upload(key, expires_in:, content_type:, content_length:, checksum:, custom_metadata: T.unsafe(nil)); end

  private

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:207
  def ensure_integrity_of(key, checksum); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:199
  def escape_glob_metacharacters(path); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:195
  def folder_for(key); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:164
  def generate_url(key, expires_in:, filename:, content_type:, disposition:); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:203
  def make_path_for(key); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:156
  def private_url(key, expires_in:, filename:, content_type:, disposition:, **_arg5); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:160
  def public_url(key, filename:, content_type: T.unsafe(nil), disposition: T.unsafe(nil), **_arg4); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:185
  def stream(key); end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:214
  def url_helpers; end

  # pkg:gem/activestorage#lib/active_storage/service/disk_service.rb:218
  def url_options; end
end
...
# pkg:gem/activestorage#lib/active_storage/transformers/vips.rb:14
class ActiveStorage::Transformers::Vips < ::ActiveStorage::Transformers::ImageProcessingTransformer
  # pkg:gem/activestorage#lib/active_storage/transformers/vips.rb:15
  def processor; end
end
...
# pkg:gem/activestorage#lib/active_storage/vips.rb:19
