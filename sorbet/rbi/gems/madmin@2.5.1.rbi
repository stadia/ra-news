...
module Madmin
  ...
  class << self
    ...
    # pkg:gem/madmin#lib/madmin.rb:86
    ...
    # pkg:gem/madmin#lib/madmin.rb:105
    def resource_names; end

    # pkg:gem/madmin#lib/madmin.rb:96
    def resources; end
...
class Madmin::ResourceBuilder
  ...
  # pkg:gem/madmin#lib/madmin/resource_builder.rb:20
  def attributes; end

  # pkg:gem/madmin#lib/madmin/resource_builder.rb:3
  def model; end

  # pkg:gem/madmin#lib/madmin/resource_builder.rb:52
  def redundant_attributes; end

  # pkg:gem/madmin#lib/madmin/resource_builder.rb:24
  def store_accessors; end

  # pkg:gem/madmin#lib/madmin/resource_builder.rb:28
