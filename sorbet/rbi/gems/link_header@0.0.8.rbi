...
#
# pkg:gem/link_header#lib/link_header/version.rb:1
class LinkHeader
  ...
  #
  # pkg:gem/link_header#lib/link_header.rb:29
  def initialize(links = T.unsafe(nil)); end

  # pkg:gem/link_header#lib/link_header.rb:37
  def <<(link); end

  # Find a member link that has the given attributes
  #
  # pkg:gem/link_header#lib/link_header.rb:108
  def find_link(*attr_pairs); end

  # An array of Link objects
  #
  # pkg:gem/link_header#lib/link_header.rb:10
  def links; end
  ...
  #
  # pkg:gem/link_header#lib/link_header.rb:49
  def to_a; end

  # Render as a list of HTML link elements
  #
  # pkg:gem/link_header#lib/link_header.rb:119
  ...
  #
  # pkg:gem/link_header#lib/link_header.rb:61
  def to_s; end
  ...
  class << self
    ...
    #        ["http://example.com/", [["rel", "up"]]]]
    #
    # pkg:gem/link_header#lib/link_header.rb:85
    def parse(link_header); end
  end
end

# pkg:gem/link_header#lib/link_header.rb:74
LinkHeader::ATTR = T.let(T.unsafe(nil), Regexp)

# pkg:gem/link_header#lib/link_header.rb:76
...
#
# pkg:gem/link_header#lib/link_header.rb:71
...
#   => '<http://example.com/foo>; rel="self"'
#
# pkg:gem/link_header#lib/link_header.rb:129
class LinkHeader::Link
  ...
  #   => '<http://example.com/foo>; rel="self"'
  #
  # pkg:gem/link_header#lib/link_header.rb:152
  def initialize(href, attr_pairs); end

  # Access #attrs by key
  #
  # pkg:gem/link_header#lib/link_header.rb:171
  def [](key); end
  ...
  #
  # pkg:gem/link_header#lib/link_header.rb:144
  def attr_pairs; end
  ...
  #   => {"rel" =>"canonical"}
  #
  # pkg:gem/link_header#lib/link_header.rb:164
  def attrs; end
  ...
  #
  # pkg:gem/link_header#lib/link_header.rb:136
  def href; end
  ...
  #
  # pkg:gem/link_header#lib/link_header.rb:181
  def to_a; end
  ...
  #
  # pkg:gem/link_header#lib/link_header.rb:203
  def to_html; end
  ...
  #   #=> '<http://example.com/foo>; rel="self"'
  #
  # pkg:gem/link_header#lib/link_header.rb:194
  def to_s; end
end

# pkg:gem/link_header#lib/link_header.rb:73
LinkHeader::QUOTED = T.let(T.unsafe(nil), Regexp)

# pkg:gem/link_header#lib/link_header.rb:75
LinkHeader::SEMI = T.let(T.unsafe(nil), Regexp)

# pkg:gem/link_header#lib/link_header.rb:72
LinkHeader::TOKEN = T.let(T.unsafe(nil), Regexp)

# pkg:gem/link_header#lib/link_header/version.rb:2
