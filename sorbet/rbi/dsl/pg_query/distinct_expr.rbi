...
# This is an autogenerated file for dynamic methods in `PgQuery::DistinctExpr`.
# Please instead update this file by running `bin/tapioca dsl PgQuery::DistinctExpr`.


class PgQuery::DistinctExpr < Google::Protobuf::AbstractMessage
  sig do
    params(
