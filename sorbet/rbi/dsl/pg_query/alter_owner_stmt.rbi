...
# This is an autogenerated file for dynamic methods in `PgQuery::AlterOwnerStmt`.
# Please instead update this file by running `bin/tapioca dsl PgQuery::AlterOwnerStmt`.


class PgQuery::AlterOwnerStmt < Google::Protobuf::AbstractMessage
  sig do
    params(
  ...
  def initialize(newowner: nil, object: nil, object_type: nil, relation: nil); end
