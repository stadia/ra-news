...
# This is an autogenerated file for dynamic methods in `Fedipub::ClientController`.
# Please instead update this file by running `bin/tapioca dsl Fedipub::ClientController`.
