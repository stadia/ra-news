...
# This is an autogenerated file for dynamic methods in `Federails::ClientController`.
# Please instead update this file by running `bin/tapioca dsl Federails::ClientController`.


class Federails::ClientController
