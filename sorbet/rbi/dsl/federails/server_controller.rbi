...
# This is an autogenerated file for dynamic methods in `Federails::ServerController`.
# Please instead update this file by running `bin/tapioca dsl Federails::ServerController`.


class Federails::ServerController
