...
# This is an autogenerated file for dynamic methods in `Api::V1::FeedController`.
# Please instead update this file by running `bin/tapioca dsl Api::V1::FeedController`.
