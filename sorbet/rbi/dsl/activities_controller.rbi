...
# This is an autogenerated file for dynamic methods in `ActivitiesController`.
# Please instead update this file by running `bin/tapioca dsl ActivitiesController`.
