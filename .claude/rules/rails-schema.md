...
- **posts** (18 cols) — body:text, boosters_count:integer(=0), children_count:integer(=0), depth:integer(=0), federated_url:string, lft:integer, likers_count:integer(=0), media_attachments:jsonb(=[]), parent_id:bigint, rgt:integer, slug:string, title:string, url:string | FK: article_id→articles | Idx: federated_url(unique), parent_id+created_at, slug(unique)
