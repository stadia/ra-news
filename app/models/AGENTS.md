...
- **Article** (table: articles) — has_one :pg_search_document, belongs_to :user, belongs_to :site, has_many :posts, has_many :taggings, has_many :base_tags, has_many :tag_taggings, has_many :tags, belongs_to :federails_actor [6v]
