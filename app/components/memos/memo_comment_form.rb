...
class Components::Memos::MemoCommentForm < Components::Base
  ...
  def submit_section(f)
    div(class: "flex items-center justify-end") do
      render RubyUI::Button.new(
        type: "submit",
        size: :xl,
        class: "inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors"
      ) { "댓글 작성" }
    end
  end
end
